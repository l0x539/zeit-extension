    ...
    chrome.storage.local.get('apiKey', function (result) {
        return __awaiter(this, void 0, void 0, function* () {
            if (message.message == 'integration-start-stop') {
                ...
                const pause = yield request_1.request('/api/v1/usr/time_records/pause', 'POST', {}, result.apiKey);
                if (pause.status === 200) {
                    sendMessagePromise(sender.tab.id, 'PAUSED');
                }
                else if (pause.status === 201) {
                    request_1.request('/api/v1/usr/time_records/resume', 'POST', {}, result.apiKey);
        ...
        return __awaiter(this, void 0, void 0, function* () {
            chrome.storage.local.get('settings', (results) => __awaiter(this, void 0, void 0, function* () {
                ...
                if ((_a = results === null || results === void 0 ? void 0 : results.settings) === null || _a === void 0 ? void 0 : _a.startBrowser) {
                    const start = yield request_1.request('/api/v1/usr/time_records/start', 'POST', {}, result.apiKey);
                    if (start.status === 200) {
                        const resume = yield request_1.request('/api/v1/usr/time_records/resume', 'POST', {}, result.apiKey);
                        if (resume.status === 201) {
                            chrome_1.notify('ZEIT.IO', 'Timer Resumed');
                        }
                    }
                    else if (start.status === 201) {
                        chrome_1.notify('ZEIT.IO', 'Timer Started');
                    }
                }
            }));
        });
        ...
        return __awaiter(this, void 0, void 0, function* () {
            chrome.storage.local.get('settings', (results) => __awaiter(this, void 0, void 0, function* () {
                ...
                if ((_a = results === null || results === void 0 ? void 0 : results.settings) === null || _a === void 0 ? void 0 : _a.StopBrowser) {
                    const pause = yield request_1.request('/api/v1/usr/time_records/pause', 'POST', {}, result.apiKey);
                    if (pause.status !== 200) {
                        chrome_1.notify('ZEIT.IO', 'Timer Paused');
                    }
                }
            }));
        });
    ...
    return yield chrome.storage.local.get('apiKey', function (result) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (start.status === 404) {
                ...
                chrome_1.notify('ZEIT.IO', 'You\'re not logged in.');
                return;
            }
            else if (start.status === 200) {
                const pause = yield request_1.request('/api/v1/usr/time_records/pause', 'POST', {}, result.apiKey);
                if (pause.status === 200) {
                    yield request_1.request('/api/v1/usr/time_records/resume', 'POST', {}, result.apiKey);
                    if (tabId)
...
chrome_1.registerCommandAction(startStop, 'start-stop', 'settings');
...
exports.useStore = use_chrome_storage_1.createChromeStorageStateHookLocal('apiKey');
exports.useUserInfos = use_chrome_storage_1.createChromeStorageStateHookLocal('user');
exports.useClock = use_chrome_storage_1.createChromeStorageStateHookLocal('clock');
exports.useComment = use_chrome_storage_1.createChromeStorageStateHookLocal('comment');
exports.useTicket = use_chrome_storage_1.createChromeStorageStateHookLocal('ticket', {
    ticketBase: null,
    ticketType: null,
    title: null,
    ticketId: null,
});
exports.useSettings = use_chrome_storage_1.createChromeStorageStateHookLocal('settings', {
    startStop: false,
    startBrowser: false,
    StopBrowser: false,
    alarmReminder: false,
...
/* harmony export */   "createChromeStorageStateHookLocal": () => (/* binding */ u),
/* harmony export */   "createChromeStorageStateHookSync": () => (/* binding */ i),
/* harmony export */   "useChromeStorageLocal": () => (/* binding */ c),
/* harmony export */   "useChromeStorageSync": () => (/* binding */ s)
/* harmony export */ });
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! react */ "./node_modules/react/index.js");
function e(e,o,c){const[s]=(0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(()=>"function"==typeof o?o():o),[u]=(0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(c),[i,f]=(0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(s),[a,h]=(0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(!0),[m,l]=(0,react__WEBPACK_IMPORTED_MODULE_0__.useState)("");(0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(()=>{((n,t,r)=>{const e=void 0===t?n:{[n]:t};return new Promise((t,o)=>{chrome.storage[r].get(e,r=>{const e=chrome.runtime.lastError;if(e)return o(e);t(r[n])})})})(e,s,u).then(n=>{f(n),h(!0),l("")}).catch(n=>{h(!1),l(n)})},[e,s,u]);const g=(0,react__WEBPACK_IMPORTED_MODULE_0__.useCallback)(n=>{const t="function"==typeof n?n(i):n;f(t),((n,t,r)=>new Promise((e,o)=>{chrome.storage[r].set({[n]:t},()=>{const n=chrome.runtime.lastError;n?o(n):e()})}))(e,t,u).then(()=>{h(!0),l("")}).catch(n=>{h(!1),l(n)})},[u,e,i]);return (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(()=>{const n=(n,t)=>{t===u&&e in n&&(f(n[e].newValue),h(!0),l(""))};return chrome.storage.onChanged.addListener(n),()=>{chrome.storage.onChanged.removeListener(n)}},[e,u]),[i,g,a,m]}function o(n,o,c){const s=[];return function(){const[u,i,f,a]=e(n,o,c),h=(0,react__WEBPACK_IMPORTED_MODULE_0__.useCallback)(n=>{for(const t of s)t(n)},[]);return (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(()=>(s.push(i),()=>{s.splice(s.indexOf(i),1)}),[i]),[u,h,f,a]}}function c(n,t){return e(n,t,"local")}function s(n,t){return e(n,t,"sync")}function u(n,t){return o(n,t,"local")}function i(n,t){return o(n,t,"sync")}
