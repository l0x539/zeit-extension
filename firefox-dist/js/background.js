...
/***/ "./node_modules/use-chrome-storage/dist/index.es.js":
/*!**********************************************************!*\
  !*** ./node_modules/use-chrome-storage/dist/index.es.js ***!
  \**********************************************************/
/*! exports provided: createChromeStorageStateHookLocal, createChromeStorageStateHookSync, useChromeStorageLocal, useChromeStorageSync */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "createChromeStorageStateHookLocal", function() { return u; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "createChromeStorageStateHookSync", function() { return i; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "useChromeStorageLocal", function() { return c; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "useChromeStorageSync", function() { return s; });
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! react */ "./node_modules/react/index.js");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
function e(e,o,c){const[s]=Object(react__WEBPACK_IMPORTED_MODULE_0__["useState"])(()=>"function"==typeof o?o():o),[u]=Object(react__WEBPACK_IMPORTED_MODULE_0__["useState"])(c),[i,f]=Object(react__WEBPACK_IMPORTED_MODULE_0__["useState"])(s),[a,h]=Object(react__WEBPACK_IMPORTED_MODULE_0__["useState"])(!0),[m,l]=Object(react__WEBPACK_IMPORTED_MODULE_0__["useState"])("");Object(react__WEBPACK_IMPORTED_MODULE_0__["useEffect"])(()=>{((n,t,r)=>{const e=void 0===t?n:{[n]:t};return new Promise((t,o)=>{chrome.storage[r].get(e,r=>{const e=chrome.runtime.lastError;if(e)return o(e);t(r[n])})})})(e,s,u).then(n=>{f(n),h(!0),l("")}).catch(n=>{h(!1),l(n)})},[e,s,u]);const g=Object(react__WEBPACK_IMPORTED_MODULE_0__["useCallback"])(n=>{const t="function"==typeof n?n(i):n;f(t),((n,t,r)=>new Promise((e,o)=>{chrome.storage[r].set({[n]:t},()=>{const n=chrome.runtime.lastError;n?o(n):e()})}))(e,t,u).then(()=>{h(!0),l("")}).catch(n=>{h(!1),l(n)})},[u,e,i]);return Object(react__WEBPACK_IMPORTED_MODULE_0__["useEffect"])(()=>{const n=(n,t)=>{t===u&&e in n&&(f(n[e].newValue),h(!0),l(""))};return chrome.storage.onChanged.addListener(n),()=>{chrome.storage.onChanged.removeListener(n)}},[e,u]),[i,g,a,m]}function o(n,o,c){const s=[];return function(){const[u,i,f,a]=e(n,o,c),h=Object(react__WEBPACK_IMPORTED_MODULE_0__["useCallback"])(n=>{for(const t of s)t(n)},[]);return Object(react__WEBPACK_IMPORTED_MODULE_0__["useEffect"])(()=>(s.push(i),()=>{s.splice(s.indexOf(i),1)}),[i]),[u,h,f,a]}}function c(n,t){return e(n,t,"local")}function s(n,t){return e(n,t,"sync")}function u(n,t){return o(n,t,"local")}function i(n,t){return o(n,t,"sync")}
...
Object.defineProperty(exports, "__esModule", { value: true });
const request_1 = __webpack_require__(/*! ../utils/request */ "./src/utils/request.tsx");
const chrome_1 = __webpack_require__(/*! ../utils/chrome */ "./src/utils/chrome.tsx");
const sendMessagePromise = (tabId, item) => {
    return new Promise((resolve, reject) => {
        chrome.tabs.sendMessage(tabId, { item }, (response) => {
            if (response === null || response === void 0 ? void 0 : response.complete) {
                resolve('fullfilled');
            }
            else {
    ...
    chrome.storage.local.get('apiKey', function (result) {
        return __awaiter(this, void 0, void 0, function* () {
            if (message.message == 'integration-start-stop') {
                ...
                const pause = yield (0, request_1.request)('/api/v1/usr/time_records/pause', 'POST', {}, result.apiKey);
                if (pause.status === 200) {
                    sendMessagePromise(sender.tab.id, 'PAUSED');
                }
                else if (pause.status === 201) {
                    (0, request_1.request)('/api/v1/usr/time_records/resume', 'POST', {}, result.apiKey);
...
chrome.windows.onCreated.addListener(function () {
    chrome.storage.local.get('apiKey', function (result) {
        return __awaiter(this, void 0, void 0, function* () {
            chrome.storage.local.get('settings', (results) => __awaiter(this, void 0, void 0, function* () {
                var _a;
                if ((_a = results === null || results === void 0 ? void 0 : results.settings) === null || _a === void 0 ? void 0 : _a.startBrowser) {
                    const start = yield (0, request_1.request)('/api/v1/usr/time_records/start', 'POST', {}, result.apiKey);
                    if (start.status === 200) {
                        const resume = yield (0, request_1.request)('/api/v1/usr/time_records/resume', 'POST', {}, result.apiKey);
                        if (resume.status === 201) {
                            (0, chrome_1.notify)('ZEIT.IO', 'Timer Resumed');
                        }
                    }
                    else if (start.status === 201) {
                        (0, chrome_1.notify)('ZEIT.IO', 'Timer Started');
                    }
                }
            }));
        });
...
chrome.windows.onRemoved.addListener(function () {
    chrome.storage.local.get('apiKey', function (result) {
        return __awaiter(this, void 0, void 0, function* () {
            chrome.storage.local.get('settings', (results) => __awaiter(this, void 0, void 0, function* () {
                var _a;
                if ((_a = results === null || results === void 0 ? void 0 : results.settings) === null || _a === void 0 ? void 0 : _a.StopBrowser) {
                    const pause = yield (0, request_1.request)('/api/v1/usr/time_records/pause', 'POST', {}, result.apiKey);
                    if (pause.status !== 200) {
                        (0, chrome_1.notify)('ZEIT.IO', 'Timer Paused');
                    }
                }
            }));
        });
...
const startStop = (tabId = undefined) => __awaiter(void 0, void 0, void 0, function* () {
    return yield chrome.storage.local.get('apiKey', function (result) {
        return __awaiter(this, void 0, void 0, function* () {
            const start = yield (0, request_1.request)('/api/v1/usr/time_records/start', 'POST', {}, result.apiKey);
            if (start.status === 404) {
                if (tabId)
                    sendMessagePromise(tabId, 'ERROR');
                (0, chrome_1.notify)('ZEIT.IO', 'You\'re not logged in.');
                return;
            }
            else if (start.status === 200) {
                const pause = yield (0, request_1.request)('/api/v1/usr/time_records/pause', 'POST', {}, result.apiKey);
                if (pause.status === 200) {
                    yield (0, request_1.request)('/api/v1/usr/time_records/resume', 'POST', {}, result.apiKey);
                    if (tabId)
                        sendMessagePromise(tabId, 'STARTED');
                    (0, chrome_1.notify)('ZEIT.IO', 'Timer Resumed');
                    return;
                }
                else if (pause.status === 201) {
                    if (tabId)
                        sendMessagePromise(tabId, 'PAUSED');
                    (0, chrome_1.notify)('ZEIT.IO', 'Timer Paused');
                    return;
                }
            }
            ...
            if (tabId)
                sendMessagePromise(tabId, 'STOPPED');
        });
    });
});
// context Right Click
...
(0, chrome_1.registerCommandAction)(startStop, 'start-stop', 'settings');
...
Object.defineProperty(exports, "__esModule", { value: true });
exports.useSettings = exports.useTicket = exports.useComment = exports.useClock = exports.useUserInfos = exports.useStore = exports.registerCommandAction = exports.notify = exports.reload = void 0;
const use_chrome_storage_1 = __webpack_require__(/*! use-chrome-storage */ "./node_modules/use-chrome-storage/dist/index.es.js");
const reload = () => {
    chrome.runtime.reload();
};
...
const notify = (title, description) => {
    chrome.storage.local.get('settings', (results) => __awaiter(void 0, void 0, void 0, function* () {
...
const registerCommandAction = (func, command, key) => {
    chrome.commands.onCommand.addListener((cmd) => {
        if (cmd === command) {
            chrome.storage.local.get(key, (results) => {
                var _a;
                if ((_a = results === null || results === void 0 ? void 0 : results.settings) === null || _a === void 0 ? void 0 : _a.startStop) {
                    func();
                }
            });
        }
...
exports.useStore = (0, use_chrome_storage_1.createChromeStorageStateHookLocal)('apiKey');
exports.useUserInfos = (0, use_chrome_storage_1.createChromeStorageStateHookLocal)('user');
exports.useClock = (0, use_chrome_storage_1.createChromeStorageStateHookLocal)('clock');
exports.useComment = (0, use_chrome_storage_1.createChromeStorageStateHookLocal)('comment');
exports.useTicket = (0, use_chrome_storage_1.createChromeStorageStateHookLocal)('ticket', {
    ticketBase: null,
    ticketType: null,
    title: null,
    ticketId: null,
});
exports.useSettings = (0, use_chrome_storage_1.createChromeStorageStateHookLocal)('settings', {
    startStop: false,
    startBrowser: false,
    StopBrowser: false,
    alarmReminder: false,
...
Object.defineProperty(exports, "__esModule", { value: true });
exports.API_URL = exports.WAGE_CATEGORIES = exports.CURRENCIES = void 0;
/*
 * Constants
 */
exports.CURRENCIES = {
...
const constants_1 = __webpack_require__(/*! ./constants */ "./src/utils/constants.tsx");
const request = (route, method, data = null, apiKey = undefined, params = '') => {
    return fetch(constants_1.API_URL + route + params, {
        method: method,
        headers: {
